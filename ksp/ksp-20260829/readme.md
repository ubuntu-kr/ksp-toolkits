# UbuCon Korea X MiniDebConf Korea 2026 - OpenPGP 키사이닝 파티
...
> 이번 키사이닝 파티는 UbuCon Korea X MiniDebConf Korea 2026 프로그램의 일부로, 티켓 구입 하시고 오프라인으로 참여 하셔야 참여 가능합니다. [티켓은 여기에서 구입 가능합니다.](https://d2025.ubuntu-kr.org/tickets/)
...
- 준비된 PGP 키의 핑거프린트 전체(40자리)를 UbuCon Korea X MiniDebConf Korea 2026 참가 등록 시 `OpenPGP Key Fingerprint ` 입력란에 넣어서 제출 해 주세요.
  - [참가 등록 링크](#)
...
- [ksp-uck26-print.pdf](https://raw.githubusercontent.com/ubuntu-kr/ksp-toolkits/master/ksp/ksp-20250829/ksp-uck26-print.pdf)
    - 인쇄용 워크시트 PDF 파일(참가자 공개키 정보, 체크섬 기입란 등 포함)
- [ksp-uck26.txt](https://raw.githubusercontent.com/ubuntu-kr/ksp-toolkits/master/ksp/ksp-20250829/ksp-uck26.txt)
    - 워크시트 파일(참가자 공개키 정보, 체크섬 기입란 등 포함)
- [ksp-uck26.txt.asc](https://raw.githubusercontent.com/ubuntu-kr/ksp-toolkits/master/ksp/ksp-20250829/ksp-uck26.txt.asc)
    - ksp-uck26.txt 파일을 PGP 키 `22BE 5648 7B69 D6CD F99D 45AF ACFF 5149 B117 571E` 로 clearsign 한 파일
- [ksp-uck26.txt.sha256](https://raw.githubusercontent.com/ubuntu-kr/ksp-toolkits/master/ksp/ksp-20250829/ksp-uck26.txt.sha256)
    - ksp-uck26.txt 파일의 SHA256 체크섬을 기록한 파일
- [ksp-uck26.txt.sha256.asc](https://raw.githubusercontent.com/ubuntu-kr/ksp-toolkits/master/ksp/ksp-20250829/ksp-uck26.txt.sha256.asc)
    - ksp-uck26.txt.sha256 파일을 PGP 키 `22BE 5648 7B69 D6CD F99D 45AF ACFF 5149 B117 571E` 로 clearsign 한 파일
